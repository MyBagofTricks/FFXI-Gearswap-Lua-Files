...
function init_gear_sets()
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {neck="Eddy Necklace"})
    ...
    sets.midcast.FastRecast = {
        ...
        back="Swith Cape",waist="Goading Belt",legs="Hagondes Pants +1",feet="Hagondes Sabots +1"}
    ...
    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",
        ...
        back="Pahtli Cape",waist=gear.ElementalObi,legs="Nares Trews",feet="Hagondes Sabots +1"}
    ...
    sets.midcast['Enfeebling Magic'] = {main="Ngqoqwanb",sub="Zuuxowu Grip",ammo="Witchstone",
    ...
    sets.midcast['Dark Magic'] = {main="Ngqoqwanb",sub="Zuuxowu Grip",ammo="Witchstone",
        head="Nahtirah Hat",neck="Eddy Necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Strendu Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Goading Belt",legs="Bokwus Slops",feet="Bokwus Boots"}

    sets.midcast.Drain = {main="Ngqoqwanb",sub="Zuuxowu Grip",ammo="Witchstone",
        head="Nahtirah Hat",neck="Eddy Necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Strendu Ring",ring2="Sangoma Ring",
    ...
    sets.midcast.Stun = {main="Ngqoqwanb",sub="Zuuxowu Grip",ammo="Witchstone",
        head="Nahtirah Hat",neck="Eddy Necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Strendu Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Witful Belt",feet="Bokwus Boots"}

    sets.midcast.BardSong = {main="Ngqoqwanb",sub="Mephitis Grip",ammo="Witchstone",
        head="Nahtirah Hat",neck="Eddy Necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
    ...
    sets.midcast['Elemental Magic'] = {main="Ngqoqwanb",sub="Zuuxowu Grip",ammo="Dosis Tathlum",
        ...
        body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Icesoul Ring",ring2="Sangoma Ring",
        back="Toro Cape",waist=gear.ElementalObi,legs="Hagondes Pants +1",feet="Hagondes Sabots +1"}

    sets.midcast['Elemental Magic'].Resistant = {main="Ngqoqwanb",sub="Zuuxowu Grip",ammo="Dosis Tathlum",
        head="Hagondes Hat +1",neck="Eddy Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Hagondes Coat +1",hands=gear.macc_hagondes,ring1="Icesoul Ring",ring2="Sangoma Ring",
        back="Toro Cape",waist=gear.ElementalObi,legs="Hagondes Pants +1",feet="Bokwus Boots +1"}
    ...
    sets.idle = {main="Bolelabunga", sub="Genbu's Shield",ammo="Dosis Tathlum",
        head="Wivre Hairpin",neck="Wiglen Gorget",ear1="Black Earring",ear2="Black Earring",
        body="Hagondes Coat +1",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Repulse Mantle",waist="Fucho-no-obi",legs="Nares Trews",feet="Hagondes Sabots +1"}
