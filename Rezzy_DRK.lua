...
function init_gear_sets()
	...
	sets.precast.FC = {ear2="Loquacious Earring",legs="Enif Cosciales"}
	...
	back="Niht Mantle",waist=gear.ElementalBelt,legs="Miki. Cuisses",feet="Ejekamal Boots"}
	...
	sets.midcast.FastRecast = {head="Otomi Helm",body="Xaddi Mail",hands="Bale Gauntlets +2",
							waist="Phos Belt",legs="Cizin Breeches +2",feet="Ejekamal Boots"}
		
	-- Specific spells
	sets.midcast.Utsusemi = {head="Otomi Helm",body="Xaddi Mail",hands="Bale Gauntlets +2",
							waist="Phos Belt",legs="Cizin Breeches +2",feet="Ejekamal Boots"}
	...
	sets.idle.Town = {main="Ragnarok", sub="Pole Grip",ammo="Yetshila",
		...
		back="Repulse Mantle",waist="Flume Belt +1",legs="Cizin Breeches +1",feet="Ejekamal Boots"}
	...
	back="Atheling Mantle",waist="Olseni Belt",legs="Cizin Breeches +1",feet="Ejekamal Boots"}
