...
function init_gear_sets()
    ...
    sets.precast.WS['Resolution'] = {ammo="Aqreqaq Bomblet",
            head="Whirlpool Mask", neck="Thunder Gorget", ear1="Brutal Earring", ear2="Moonshade Earring",
            body="Manibozho Jerkin", hands="Qaaxo Mitaines", ring1="Karieyh Ring", ring2="Epona's Ring",
    ...
    sets.precast.WS['Resolution'].Acc = set_combine(sets.precast.WS['Resolution'].Normal, 
        {ammo="Honed Tathlum", hands="Umuthi Gloves", back="Evasionist's Cape", legs="Manibozho Legs"})
    sets.precast.WS['Dimidiation'] = {ammo="Thew Bomblet",
            ...
            body="Dread Jupon", hands="Futhark Mitons +1", ring1="Karieyh Ring", ring2="Epona's Ring",
    ...
    sets.idle = {ammo='Inlamvuyeso',
            head="Wivre Hairpin", neck="Wiglen Gorget", ear1="Ethereal earring", ear2="Moonshade earring",
            body="Thaumas Coat", hands="Umuthi Gloves", ring1="Karieyh Ring", ring2="Paguroidea ring",
            back="Evasionist's Cape", waist="Flume Belt +1", legs="Quiahuiz Trousers", feet="Hermes' Sandals"}
