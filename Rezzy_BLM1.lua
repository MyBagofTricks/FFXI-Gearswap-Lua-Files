...
function init_gear_sets()
    ...
    sets.midcast['Enfeebling Magic'] = {main="Baqil Staff",sub="Wise Strap",ammo="Witchstone",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Baqil Staff",sub="Wise Strap",ammo="Witchstone",
        head="Hagondes Hat",neck="Quanpur Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Hagondes Coat",hands="Yaoyotl Gloves",ring1="Icesoul Ring",ring2="Strendu Ring",
        back="Toro Cape",waist=gear.ElementalObi,legs="Hagondes Pants",feet="Hagondes Sabots"}
    ...
    sets.midcast['Elemental Magic'].Proc = {main="Baqil Staff",sub="Wise Strap",ammo="Witchstone",
        head="Hagondes Hat",neck="Quanpur Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Hagondes Coat",hands="Yaoyotl Gloves",ring1="Icesoul Ring",ring2="Strendu Ring",
        back="Toro Cape",waist=gear.ElementalObi,legs="Hagondes Pants",feet="Hagondes Sabots"}
    ...
    sets.idle = {main="Baqil Staff", sub="Wise Strap",ammo="Witchstone",
        head="Wivre Hairpin",neck="Wiglen Gorget",ear1="Hecate's Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Iximulew Cape",waist="Sekhmet Corset",legs="Nares Trews",feet="Hagondes Sabots"}

    -- Idle mode that keeps PDT gear on, but doesn't prevent normal gear swaps for precast/etc.
    sets.idle.PDT = {main="Baqil Staff", sub="Wise Strap",ammo="Witchstone",
        head="Wivre Hairpin",neck="Wiglen Gorget",ear1="Hecate's Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Iximulew Cape",waist="Sekhmet Corset",legs="Nares Trews",feet="Hagondes Sabots"}
    ...
    -- Idle mode scopes:
    -- Idle mode when weak.
    sets.idle.Weak = {main="Baqil Staff", sub="Wise Strap",ammo="Witchstone",
        head="Wivre Hairpin",neck="Wiglen Gorget",ear1="Hecate's Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Iximulew Cape",waist="Sekhmet Corset",legs="Nares Trews",feet="Hagondes Sabots"}
    
    -- Town gear.
    sets.idle.Town = {main="Baqil Staff", sub="Wise Strap",ammo="Witchstone",
        head="Wivre Hairpin",neck="Wiglen Gorget",ear1="Hecate's Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Iximulew Cape",waist="Sekhmet Corset",legs="Nares Trews",feet="Hagondes Sabots"}
